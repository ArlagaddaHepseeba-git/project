...
public class UserService {
    ...
    public String register(RegisterRequest request) {
        ...
        return "Database is disabled. Register API is temporarily unavailable.";
    }
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        response.setMessage("Database is disabled");
        response.setUserId("CC1001");
        response.setName("Demo User");
        response.setEmail(request.getEmail());
        response.setCourse("Java Full Stack");
    ...
    public LoginResponse getProfile(String userId) {
        ...
        response.setName("Demo User");
        response.setEmail("demo@test.com");
        response.setCourse("Java Full Stack");
    ...
    public String updateProfile(String userId, UpdateProfileRequest request) {
        ...
        return "Database is disabled. Profile update skipped.";
    }
    ...
    public String changePassword(ChangePasswordRequest request) {
        ...
        return "Database is disabled. Password cannot be changed.";
    }
}
//with DB
//package com.example.demo.service;
